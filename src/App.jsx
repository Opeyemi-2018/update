        ...
        <div className="pb-20 md:pb-24 w-full max-w-screen-xl xl:mx-auto ">
          <div className="relative min-h-[600px] w-full">
            <div className="absolute bottom-0 left-0 top-2 w-[2px] bg-gray-100 md:left-[25%] after:absolute after:inset-x-0 after:bottom-0 after:h-48 after:bg-gradient-to-b after:from-gray-100 after:to-white"></div>
                ...
                {notes.map((note) => {
                  let { id, date, photonIQ, Prerender, whatsnew, whatsNewContents, Improvement, improvementContents, bugFix, bugFixContents } = note;
                  return (
                    <div key={id} className="ml-6 grid grid-cols-1 pb-20 md:ml-0 md:grid-cols-4 ">
                      <div className="relative col-span-1 mb-4 flex flex-row  items-center justify-between md:mb-0 md:flex-col md:items-start md:justify-start">
                        <div className=" text-gray-600 md:mb-1 whitespace-nowrap">{date}</div>
                      ...
                      <div className="col-span-3 sm:ml-20 ml-0">
                        ...
                        <div className="flex flex-col space-y-2 my-4">
                          ...
                          <div className="flex flex-col gap-y-3">
                            <div className="text-base">
                              {improvementContents.map((improvementContent, index) => {
                                return (
                                  <ul key={index} className="ml-9">
                                    <li className="relative text-[16px] ml-6 before:absolute before:-left-6 before:top-2 before:h-2 before:w-2 before:rounded-full before:border-2 before:border-gray-300">
                                      {improvementContent}
